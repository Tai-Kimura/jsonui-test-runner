...
def get_flow_styles() -> list[str]:
    ...
    styles.extend([
        ...
        "    .block-steps .inline-step { display: flex; align-items: center; gap: 8px; padding: 6px 0; flex-wrap: wrap; }",
        "    .block-steps .step-type-badge { padding: 2px 8px; font-size: 0.75em; }",
        "    /* Setup/Teardown */",
