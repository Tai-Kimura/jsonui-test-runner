...
def _get_html_header(title: str) -> list[str]:
    ...
    parts = [
        ...
        "      vertical-align: top;",
        "    }",
        "    .properties-table td:nth-child(1) { white-space: nowrap; }",
        "    .properties-table td:nth-child(2) { white-space: nowrap; }",
        "    .properties-table td:nth-child(5) { white-space: nowrap; }",
